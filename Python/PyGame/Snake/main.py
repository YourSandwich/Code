...
class SNAKE:
    def __init__(self):
        ...
        self.head_up = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/head.png').convert_alpha()
        self.head_down = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/headD.png').convert_alpha()
        self.head_left = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/headL.png').convert_alpha()
        self.head_right = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/headR.png').convert_alpha()

        self.tail_up = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/tailU.png').convert_alpha()
        self.tail_down = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/tailD.png').convert_alpha()
        self.tail_left = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/tailL.png').convert_alpha()
        self.tail_right = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/tailR.png').convert_alpha()

        self.bend_up = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/bendU.png').convert_alpha()
        self.bend_down = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/bendD.png').convert_alpha()
        self.bend_left = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/bendL.png').convert_alpha()
        self.bend_right = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/bendR.png').convert_alpha()

        self.body_vertical = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/body.png').convert_alpha()
        self.body_horizontal = pygame.image.load(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/bodyH.png').convert_alpha()

        self.crunch_sound = pygame.mixer.Sound(
            '/mnt/Data/Müll/Code/Python/PyGame/Snake/Audio/crunch.wav')
...
cherry = pygame.image.load(
    '/mnt/Data/Müll/Code/Python/PyGame/Snake/Texture/cherry2.png').convert_alpha()
game_font = pygame.font.Font(
    '/mnt/Data/Müll/Code/Python/Assets/Fonts/PinkChicken-Regular.ttf', 31)
